...
Currently, there are two concept examples that show this plugin in more detail, in the Semantic Kernel samples:

- Plugin example showing the basic usage of calling the code execute function on the plugin.
- Function calling example showing a simple chat application that leverages the Python code interpreter plugin.
